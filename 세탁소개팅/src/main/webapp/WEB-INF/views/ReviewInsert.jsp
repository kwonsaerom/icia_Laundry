...
<div class="wrapper row1">
  ...
  <div id="nn">
   ...
   <!-- 매장정보 DIV -->
   <div id="SHOPINFO">
   <form name="reviewAddFrm" method="post" enctype="multipart/form-data">
<!-- <p><form name="commentForm" method="post"> -->
<input type="hidden" name="re_nrcode" value="${r.re_nrcode}">
<input type="hidden" name="re_nlcode" value="${r.re_nlcode}">
<%-- ${Ldinfo} --%>
리뷰작성하기 
 <div id="re">   
         <p>
...
<textarea rows="6" cols="50" name="re_content" placeholder="솔직한 의견도 좋지만 무조건적인 비방은 삼가주세요 ^^"></textarea>
...
<span class="star-input"><span class="input">
      <input type="radio" name="re_star" id="p1" value="1" onclick=""><label for="p1">1</label>
      <input type="radio" name="re_star" id="p2" value="2" ><label for="p2">2</label>
      <input type="radio" name="re_star" id="p3" value="3" ><label for="p3">3</label>
      <input type="radio" name="re_star" id="p4" value="4" ><label for="p4">4</label>
      <input type="radio" name="re_star" id="p5" value="5" ><label for="p5">5</label>
      <input type="hidden" name="re_star" value="0">
      </span>
      </span>
<input type="button" value="리뷰등록" onclick="commentbtn()"/>
</div>
</form></div> 
...
function commentbtn() {
   ...
   document.reviewAddFrm.action = 'reviewAdd';
   document.reviewAddFrm.submit();
}
</script>
</html>